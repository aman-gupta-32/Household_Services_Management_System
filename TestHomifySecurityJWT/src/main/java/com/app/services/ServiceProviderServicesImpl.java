...
//	TestDTO td ;
	...
	public ApiResponse addService( ServiceRespDTO dto ,Long Id) {
		...
		UserEntity serviceprovider = ud.findById(Id).orElseThrow();//ud.findById(Id).orElseThrow(() -> new ResourceNotFoundException("Invalid Category ID!!!"));
	...
	public ApiResponse deleteService(ServiceRespDTO dto ,Long Id) {
		...
		UserEntity serviceprovider = ud.findById(Id).orElseThrow(() -> new ResourceNotFoundException("Invalid Category ID!!!"));
	...
	public ServiceProviderProfileDTO displayProfile(Long Id) {
		...
		UserEntity serviceprovider = ud.findById(Id).orElseThrow();
	...
	public ApiResponse updateProfile(ServiceProviderRespDTO dto,Long Id) {
		...
		if(ud.existsById(Id)) {
			...
			UserEntity user = ud.findById(Id).orElseThrow();

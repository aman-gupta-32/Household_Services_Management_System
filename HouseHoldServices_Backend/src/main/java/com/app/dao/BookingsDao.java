...
public interface BookingsDao extends JpaRepository<Bookings, Long> {
	...
	Boolean existsByServiceproviderAndDateAndBookingSlot(User user, Date date, Long slot);

	List<Bookings> findByServiceproviderAndDateAndBookingSlot(User user, Date date, Long slot);

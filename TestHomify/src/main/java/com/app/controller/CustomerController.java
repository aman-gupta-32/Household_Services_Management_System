...
public class CustomerController {
	...
	public ResponseEntity<?> cDisplayServices(){
		...
		@PostMapping("/slotschecking")
		public ResponseEntity<?> slotChecking(@RequestBody CustomerSlotRespDTO dto){
			
			System.out.println("verifying slot");
//			
//			 lst = cs.slotChecking(dto);
			
			if( cs.slotChecking(dto) != null) {
				return ResponseEntity.ok( cs.slotChecking(dto));
			}else
				return null;
		}
